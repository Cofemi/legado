...
object PreferKey {
    ...
    const val filterBookTypeText = "filterBookTypeText"
    const val filterBookTypeAudio = "filterBookTypeAudio"
    const val filterBookTypeImage = "filterBookTypeImage"
    const val filterBookTypeWebFile = "filterBookTypeWebFile"
    const val filterKeywords = "filterKeywords"
